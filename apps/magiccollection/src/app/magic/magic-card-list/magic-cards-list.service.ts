...
export const magicSetArray: MagicSet[] = [
    new MagicSet('MSH', 'Marvel Super Heroes', 454, 2026),
    ...
    new MagicSet('TLE', 'Avatar: The Last Airbender Eternal', 317, 2025),
    new MagicSet('SPM', 'Marvel', 286, 2025),
    ...
    new MagicSet('BIG', 'The Big Score', 95, 2024, true),
    new MagicSet('OTJ', 'Outlaws of Thunder Junction', 374, 2024),
    new MagicSet('OTP', 'Breaking News', 82, 2024, true),
    ...
    new MagicSet('WOT', 'Wilds of Eldraine: Enchanting Tales', 103, 2023, true),
    new MagicSet('MAT', 'March of the Machine: The Aftermath', 230, 2023, true),
    new MagicSet('MOM', 'March of the Machine', 479, 2023),
    new MagicSet('MUL', 'Multiverse Legends', 195, 2023, true),
    new MagicSet('ONE', 'Phyrexia: All Will Be One', 479, 2023),
    new MagicSet('BRO', "The Brothers' War", 384, 2022),
    new MagicSet('BRR', "The Brothers' War Retro Artifacts", 126, 2022, true),
    ...
    new MagicSet('STA', 'Mystical Archive', 126, 2021, true),
...
export class MagicCardsListService {
    ...
    creatingCardUrls(card: Card, isFlip = false): CardUrls {
